        ...
        <main className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            {loading ? (
              ...
              <>
                {/* Column headers */}
                <div className="px-5 py-2 grid grid-cols-[140px_1fr_100px_110px_100px_80px] gap-3 border-b border-slate-50 dark:border-slate-800/60 bg-slate-50/60 dark:bg-slate-800/30">
                  ...
                  {data.priorityQueue.map((ticket) => {
                    ...
                    return (
                      <div
                        ...
                        className="px-5 h-10 grid grid-cols-[160px_1fr_90px_110px_100px_72px] gap-3 items-center hover:bg-slate-50 dark:hover:bg-slate-800/40 cursor-pointer transition-colors group"
                      >
